...
class CharacterViewModelTest {
    ...
    fun uiState_initiallyLoading() = runTest {
        val viewModel = CharacterViewModel(FakeCharacterRepository())
        assertEquals(viewModel.uiState.first(), CharactersUiState.Loading)
    }
...
private class FakeCharacterRepository : CharacterRepository {
    ...
    override val characterData: Flow<List<String>>
